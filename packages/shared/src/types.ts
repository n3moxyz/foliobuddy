...
/**
 * Rough fallback USD->native rates for supported non-USD listed equity currencies,
...
export const USD_NOK_FALLBACK_RATE = 10.5;
...
export interface TradeAnalytics {
  ...
  totalPnL: number;
  avgPnL: number;
  /** Null represents an infinite factor (profitable trades with no losses), which JSON cannot encode. */
